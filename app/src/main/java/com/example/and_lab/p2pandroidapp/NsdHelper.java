...
public class NsdHelper {
    ...
    private final static String TAG = "NSD";
    private static String SERVICE_TYPE = "nsdchat._tcp";
    private static String mServiceName = "NsdChat";
